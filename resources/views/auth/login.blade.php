...
<div class="container" id="container">
  ...
  <img style="height:100x;width:60px"src="icon/fb.jpeg" alt="icon"/>
					   <img style="height:100x;width:60px" src="icon/gg.jpeg" alt="icon"/>
					   <img style="height:100x;width:60px" src="icon/link.jpeg" alt="icon"/>
  </a>
  	</div>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				<h1>Bienvenue chez Pharmacie !</h1>
				<p>Pour rester connecté avec nous, veuillez vous connecter avec vos informations personnelles</p>
				<button class="ghost" id="signIn">S'identifier</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Salut nouveau Client!</h1>
				<p>Entrez vos informations personnelles et commencez votre achat de médicaments</p>
...
.overlay {
	...
	background: linear-gradient(to right, #E61414,#E61414);
